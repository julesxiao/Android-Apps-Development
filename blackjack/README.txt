Black Jack
Notice:
1. Our creative portion has the bet function, so the player must hit the bet button first so the bet would be fixed. Then the player would be able to use gestures to choose hit or stand.
